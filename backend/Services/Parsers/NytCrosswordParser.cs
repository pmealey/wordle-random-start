...
namespace backend.Services.Parsers
{
    public class NytCrosswordParser : BasicTimeResultParser
    {
        ...
        protected override Regex Parser => new Regex($"(I solved the (Monday|Tuesday|Wednesday|Thursday|Saturday|Sunday) [\\d/]+ New York Times Daily Crossword in|NYTC) (?<{TimeGroup}>[:\\d\\.]+)", RegexOptions.IgnoreCase);
